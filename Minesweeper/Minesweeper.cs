    ...
    public partial class Minesweeper : Form {
        ...
        private void toolMenu1_Click(object sender, EventArgs e) {
            ...
            if (Database.color == "white") {
                ...
                toolMenu1.ForeColor = Color.FromArgb(251, 255, 227);
        ...
        private void WallpaperClick(object sender, EventArgs e) {
            Database.ChangeSound("sounds/click.wav");
            if (Database.wallpaper == "no") Database.wallpaper = "yes";
            else Database.wallpaper = "no";
            ChangeWallpaper();
        }
        private void QuestionClick(object sender, EventArgs e) {
            Database.ChangeSound("sounds/click.wav");
            if (Database.question == "yes") Database.question = "no";
            else Database.question = "yes";
            ChangeQuestion();
        }
        ...
        private void ChangeLanguage() {
            switch (Database.language) {
                case "russian":
                    ...
                    menu25.Text = "Вопросительные знаки";
                    menu25.ToolTipText = "Если включено, на пкм после флажка будет ставиться вопрос.";
                ...
                case "ukrainian":
                    ...
                    menu25.Text = "Знаки запитання";
                    menu25.ToolTipText = "Якщо увімкнено, на пкм після прапорця буде ставитися питання.";
                ...
                case "english":
                    ...
                    menu25.Text = "Question marks";
                    menu25.ToolTipText = "If enabled, a question will be put on the right-click after the flag.";
        ...
        public void ChangeColor() {
            ...
            smile.BackgroundImage = Image.FromFile(Database.GetColorPath() + "button.png");
            if (Database.wallpaper == "yes") {
                BackgroundImage = Image.FromFile("textures/themes/" + Database.GetWallpaperPath());
                menu24_3.Image = Image.FromFile(Database.GetColorPath() + "check.png");
            }
            if (Database.question == "yes") menu25.Image = Image.FromFile(Database.GetColorPath() + "check.png");
            ...
            menu25.BackColor = Database.GetColor().Item1;
            menu25.ForeColor = Database.GetColor().Item2;
        ...
        public void ChangeQuestion() {
            switch(Database.question) {
                case "yes":
                    menu25.Image = Image.FromFile(Database.GetColorPath() + "check.png");
                    break;
                case "no":
                    menu25.Image = null;
                    break;
